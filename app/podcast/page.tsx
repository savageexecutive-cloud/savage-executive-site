...
const platforms = [
  ...
  {
    name: "Apple Podcasts",
    href: "https://podcasts.apple.com/us/podcast/savage-executive-podcast/id1811171361",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Spotify",
    href: "https://open.spotify.com/show/2t9V7W1MohExbvUB0KhTzp",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Reveal className="md:col-span-3">
              <div>
                ...
                <div className="rounded-xl overflow-hidden">
                  <iframe
                    src="https://open.spotify.com/embed/show/2t9V7W1MohExbvUB0KhTzp?utm_source=generator&theme=0"
                    width="100%"
                    height="352"
                    frameBorder="0"
                    allowFullScreen
                    ...
                    loading="lazy"
                    title="Savage Executive Podcast on Spotify"
            ...
            <Reveal delay={200} className="md:col-span-2">
              <div>
                ...
                <div className="space-y-4">
                  {platforms.map((platform) => (
                    <a
                      ...
                      className="flex items-center gap-4 bg-surface-light border border-border rounded-sm p-4 hover:border-gold/50 transition-all duration-300 hover:shadow-[0_4px_20px_rgba(201,162,39,0.05)] group"
                    >
                      <span className="text-gold">{platform.icon}</span>
                      <span className="text-white">{platform.name}</span>
                      <span className="text-white/30 ml-auto transition-transform duration-300 group-hover:translate-x-1">
                        &rarr;
                      </span>
                    </a>
                  ))}
                ...
                <div className="mt-8 bg-surface-light border border-border rounded-sm p-6">
                  <h4 className="text-xs tracking-[0.2em] uppercase text-gold mb-3 font-medium">
                    About the Show
                  </h4>
